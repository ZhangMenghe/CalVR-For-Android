...
void pointDrawable::Initialization(assetLoader* loader, std::stack<glState>* stateStack) {
    glesDrawable::Initialization(loader, stateStack);
    _init(loader,"shaders/pointDrawable.vert","shaders/point.frag");
