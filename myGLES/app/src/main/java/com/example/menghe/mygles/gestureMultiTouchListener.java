...
public class gestureMultiTouchListener implements OnGestureListener,
        OnDoubleTapListener {

    public final String TAG = gestureMultiTouchListener.class.getSimpleName();
    ...
    public gestureMultiTouchListener(Context context, TextView gestureName) {
