 ...
 */
public abstract class CVandCGViewBase extends GLSurfaceView {
        //implements SurfaceHolder.Callback {

    private static final String TAG = "CVandCGView";
    ...
    public CVandCGViewBase(Context context, int cameraId) {
        super(context);
    ...
    public CVandCGViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
